...
from services.recipe_discovery import discover_recipes
from services.meal_family_classifier import (
    group_recipe_families,
    choose_family_representatives,
)
...
def row_to_recipe(row: Dict[str, Any], source: Dict[str, Any]) -> Optional[Dict[str, Any]]:
    ...
    meal_type = get_first(row, ["meal_type", "meal", "course", "MealType"], "") or infer_meal_type(display_name, category, cook_time)
