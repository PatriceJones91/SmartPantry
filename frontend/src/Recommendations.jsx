      ...
      <section className="recommendationJourney" aria-label="How Smart Pantry recommendations work">
        <div className="journeySteps">
          <article className="journeyCard journeyPantry">
            <div className="journeyIcon" aria-hidden="true">▣</div>
            <div className="journeyCopy">
              <div className="journeyStepTitle">
                <span className="journeyNumber">01</span>
                <h3>Review your pantry</h3>
              </div>
              <p>Keep quantities and expiration dates current for stronger results.</p>
            </div>
          </article>
          ...
          <article className="journeyCard journeyRank">
            ...
            <div className="journeyCopy">
              ...
              <p>Smart Pantry places urgent and stronger matches first.</p>
            </div>
          </article>
          ...
          <article className="journeyCard journeyTrack">
            ...
            <div className="journeyCopy">
              ...
              <p>Save what you made, used elsewhere, saved, or did not use.</p>
            </div>
          </article>
        </div>
      </section>
